...
namespace EPTools.Services
{
    ...
    public class NPC
    {
		...
		public List<string> Movement { get; set; } = new List<string>();
        public List<KeyValuePair<string, int>> Skills { get; set; } = new List<KeyValuePair<string, int>>();
        public List<CharacterAptitude> Aptitudes { get; set; } = null;
